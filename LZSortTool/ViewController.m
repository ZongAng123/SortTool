...
- (void)viewDidLoad {
    ...
    NSArray *arr = [SortTool sortStrings:self.nameArray withSortType:LZSortResultTypeSingleValue];
    NSArray *arr1 = [SortTool sortStrings:self.nameArray withSortType:LZSortResultTypeDoubleValues];
    ...
    NSArray *pArr = [SortTool sortObjcs:pArray byKey:@"name" withSortType:LZSortResultTypeDoubleValues];
